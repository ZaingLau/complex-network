...
def cal_cm(test_dic, predict_dic):
    # results are performed as 'str' in BY class, or 'list of str' in MULTI class.
    # 'test_list' SHOULD be a dictionary, ALSO is 'predict_list', labels' order CAN be not consist.
